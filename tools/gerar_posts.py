...
POSTS = [
    ...
    ("autismo-e-tdah", [
        {"cover": "AUTISMO E TDAH JUNTOS: A COMBINAÇÃO MAIS COMUM — E A MAIS IGNORADA."},
        {"body": "Até 2013 o DSM proibia diagnosticar autismo e TDAH na mesma pessoa. O DSM-5 corrigiu isso. Uma geração inteira foi avaliada sob a regra antiga.",
         "ref": "DSM-5 (APA, 2013); DSM-5-TR (2022)"},
        {"body": "Meta-análise de 63 estudos: cerca de 38% das pessoas autistas também preenchem critérios para TDAH. Não é exceção — é quase metade.",
         "ref": "Rong et al. (2021), Res Autism Spectr Disord"},
        {"head": "POR QUE IMPORTA", "body": "Os dois se mascaram. A desorganização é atribuída ao TDAH, a dificuldade social ao autismo — e o que sobra fica sem explicação. Avaliar um sem considerar o outro deixa metade do quadro de fora."},
        {"cta": "Comece pelo rastreio."},
    ]),
    ("alexitimia", [
        {"cover": "VOCÊ SENTE, MAS NÃO SABE NOMEAR O QUE SENTE?"},
        {"body": "Alexitimia é a dificuldade de identificar e descrever as próprias emoções. Não é ausência de sentimento — é ausência da etiqueta."},
        {"body": "Meta-análise: cerca de 50% das pessoas autistas apresentam alexitimia, contra menos de 5% na população geral.",
         "ref": "Kinnaird, Stewart & Tchanturia (2019), Eur Psychiatry"},
        {"head": "O QUE ISSO MUDA", "body": "A pesquisa sugere que várias dificuldades emocionais atribuídas ao autismo são, na verdade, da alexitimia que costuma vir junto. São coisas diferentes — e o apoio para cada uma também é."},
        {"cta": None},
    ]),
    ("dupla-empatia", [
        {"cover": "E SE O PROBLEMA NÃO FOSSE FALTA DE EMPATIA, MAS FALTA DE TRADUÇÃO?"},
        {"body": "A teoria da dupla empatia propõe que a falha de comunicação entre autistas e não autistas é mútua — não um déficit de um lado só.",
         "ref": "Milton (2012), Disability & Society"},
        {"body": "Em experimentos de transmissão de informação, grupos só de autistas passam instruções tão bem quanto grupos só de não autistas. A perda aparece nos grupos mistos.",
         "ref": "Crompton et al. (2020), Autism"},
        {"head": "A INVERSÃO", "body": "Durante décadas se mediu o quanto autistas entendiam os outros. Quase nunca se mediu o contrário. Quando se mede, o resultado é simétrico."},
        {"cta": "Conheça o seu jeito de processar o mundo."},
    ]),
    ("stimming", [
        {"cover": "BALANÇAR, GIRAR, REPETIR: O QUE O STIMMING ESTÁ FAZENDO POR VOCÊ."},
        {"body": "Stimming é comportamento autorregulatório repetitivo: balançar, bater os dedos, repetir sons, girar objetos. Está entre os critérios diagnósticos.",
         "ref": "Critério B1 do DSM-5-TR (APA, 2022)"},
        {"body": "Serve a uma função: reduzir sobrecarga, organizar a atenção, descarregar ansiedade — às vezes, simplesmente expressar alegria."},
        {"head": "POR QUE NÃO REPRIMIR", "body": "Suprimir stims não remove a necessidade que os produz. Costuma apenas transferir o custo para exaustão e ansiedade. A pergunta útil é se é seguro, não se é discreto."},
        {"cta": None},
    ]),
    ("seletividade-alimentar", [
        {"cover": "“ELE SÓ COME CINCO COISAS.” ISSO TEM NOME — E NÃO É BIRRA."},
        {"body": "Seletividade alimentar intensa é comum no autismo e frequentemente sensorial: textura, cheiro, temperatura, cor. O problema raramente é o sabor."},
        {"body": "Quando restringe a ponto de afetar nutrição ou vida social, pode configurar ARFID (transtorno alimentar restritivo evitativo), que co-ocorre com autismo em taxas muito acima da população geral.",
         "ref": "Meta-análise ARFID e autismo (2025), Int J Eat Disord"},
        {"head": "O QUE AJUDA", "body": "Forçar não funciona e aumenta a aversão. Exposição gradual, previsibilidade e apoio de nutricionista com experiência em TEA funcionam melhor."},
        {"cta": "Entenda o perfil sensorial."},
    ]),
    ("sono", [
        {"cover": "POR QUE TANTA GENTE AUTISTA NÃO CONSEGUE DORMIR?"},
        {"body": "Transtornos de sono estão entre as condições que mais co-ocorrem com autismo — junto de TDAH e ansiedade — em revisão sistemática de 96 estudos.",
         "ref": "Revisão sistemática e meta-análise (2023), Neurosci Biobehav Rev"},
        {"body": "As causas se somam: hipersensibilidade sensorial, ruminação, diferenças na regulação de melatonina e rotinas que quebram com facilidade."},
        {"head": "O QUE COSTUMA AJUDAR", "body": "Rotina previsível, controle do ambiente sensorial no quarto, e avaliação médica antes de qualquer suplemento — inclusive melatonina."},
        {"cta": None},
    ]),
    ("direitos-no-brasil", [
        {"cover": "SEUS DIREITOS COMO PESSOA AUTISTA NO BRASIL."},
        {"body": "A Lei Berenice Piana determina que a pessoa com TEA é considerada pessoa com deficiência para todos os efeitos legais — com todos os direitos que isso implica.",
         "ref": "Lei 12.764/2012"},
        {"body": "A Lei Romeo Mion criou a CIPTEA, carteira de identificação emitida gratuitamente que garante atendimento prioritário em serviços públicos e privados. Validade de cinco anos.",
         "ref": "Lei 13.977/2020"},
        {"head": "COMO SOLICITAR", "body": "A CIPTEA é pedida em órgão estadual ou municipal, com laudo médico indicando o CID. Gratuita — se cobrarem, está errado."},
        {"cta": "Primeiro passo: entender se vale investigar."},
    ]),
    ("autismo-e-envelhecimento", [
        {"cover": "ONDE ESTÃO OS AUTISTAS DE 60 ANOS?"},
        {"body": "Estão aqui. Cresceram quando o diagnóstico praticamente não existia fora de casos com deficiência intelectual associada, e envelheceram sem nunca terem sido avaliados."},
        {"body": "A pesquisa sobre autismo em idosos é escassa a ponto de ser chamada de lacuna crítica na literatura — pouquíssimos estudos acompanham essa faixa etária.",
         "ref": "Lai & Baron-Cohen (2015), Lancet Psychiatry"},
        {"head": "POR QUE IMPORTA AGORA", "body": "Serviços de saúde para idosos não foram desenhados pensando em sensibilidade sensorial ou necessidade de previsibilidade. Reconhecer muda o cuidado."},
        {"cta": "Nunca é tarde para entender."},
    ]),
    ("terapias-com-evidencia", [
        {"cover": "O QUE FUNCIONA, O QUE NÃO FUNCIONA E O QUE FAZ MAL."},
        {"head": "TEM EVIDÊNCIA", "body": "Intervenções desenvolvimentais e comportamentais naturalistas, apoio à comunicação, terapia ocupacional para questões sensoriais, adaptação de ambiente."},
        {"head": "NÃO TEM", "body": "Dietas restritivas sem indicação clínica, suplementos vendidos como tratamento, câmara hiperbárica, quelação. Nenhum demonstrou eficácia para o autismo."},
        {"body": "Quelação e “protocolos de desintoxicação” já causaram mortes documentadas. Desconfie de qualquer coisa vendida como cura — autismo não é doença a ser curada.",
         "ref": "FDA, alerta público sobre terapias sem comprovação"},
        {"cta": "Comece pelo que é sério."},
    ]),
    ("autismo-e-ansiedade", [
        {"cover": "ANSIEDADE NÃO É O DIAGNÓSTICO. ÀS VEZES É O SINTOMA."},
        {"body": "Transtornos de ansiedade estão entre as condições mais frequentes junto do autismo, logo depois do TDAH, em revisão sistemática de 96 estudos.",
         "ref": "Revisão sistemática e meta-análise (2023), Neurosci Biobehav Rev"},
        {"body": "Faz sentido: viver num ambiente sensorialmente hostil, decodificando regras sociais implícitas o dia inteiro, produz ansiedade. A causa está do lado de fora."},
        {"head": "O QUE MUDA NO TRATAMENTO", "body": "Tratar a ansiedade sem considerar o autismo costuma render anos de terapia que ajuda pouco. Quando se ajusta o ambiente e a demanda, a ansiedade cede junto."},
        {"cta": "A pergunta certa vem primeiro."},
    ]),
]
